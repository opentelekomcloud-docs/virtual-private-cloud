...
.. table:: **Table 1** Path Parameters
   ...
   +=================+=================+=================+=================================================================================================================+
   | project_id      | Yes             | String          | -  Definition: ID of the project that a security group belongs to. Multiple IDs can be specified for filtering. |
   |                 |                 |                 |                                                                                                                 |
   |                 |                 |                 | -  Range: None                                                                                                  |
   +-----------------+-----------------+-----------------+-----------------------------------------------------------------------------------------------------------------+
...
.. table:: **Table 2** Query Parameters
   ...
   +-----------------------+-----------------+------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | project_id            | No              | Array of strings | -  Definition: ID of the project that a security group belongs to. Multiple IDs can be specified for filtering.                                                           |
   |                       |                 |                  |                                                                                                                                                                           |
   |                       |                 |                  | -  Range: None                                                                                                                                                            |
   +-----------------------+-----------------+------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
