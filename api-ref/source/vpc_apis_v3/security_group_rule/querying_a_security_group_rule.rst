...
.. table:: **Table 1** Path Parameters
   ...
   |                        |                 |                 | -  Range: None                                                                                                                                                                                                                              |
   +------------------------+-----------------+-----------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | security_group_rule_id | Yes             | String          | -  Definition: Security group rule ID. You can call the API :ref:`Querying Security Group Rules <vpc_apiv3_0017>` to obtain the ID of the target security group rule, and then use this API to query details about the security group rule. |
   |                        |                 |                 |                                                                                                                                                                                                                                             |
   |                        |                 |                 | -  Range: None                                                                                                                                                                                                                              |
   +------------------------+-----------------+-----------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
