:original_name: AssociateSubnetFirewall.html

.. _AssociateSubnetFirewall:
...
.. table:: **Table 1** Path Parameters
   ...
   |                 |                 |                 |                                                                                                                                                                                                |
   |                 |                 |                 | Network ACL ID. You can call the API :ref:`Querying Network ACLs <listfirewall>` to obtain the ID of the target network ACL, and then use this API to associate the network ACL with a subnet. |
   |                 |                 |                 |                                                                                                                                                                                                |
   |                 |                 |                 | **Range**:                                                                                                                                                                                     |
   |                 |                 |                 |                                                                                                                                                                                                |
   |                 |                 |                 | N/A                                                                                                                                                                                            |
...
.. table:: **Table 2** Request body parameters
   ...
   | Parameter       | Mandatory       | Type                                                                                                             | Description                                                                                                                                                                                                                                                                       |
   +=================+=================+==================================================================================================================+===================================================================================================================================================================================================================================================================================+
   | subnets         | Yes             | Array of :ref:`RequestFirewallAssociation <associatesubnetfirewall__request_requestfirewallassociation>` objects | **Definition**:                                                                                                                                                                                                                                                                   |
   |                 |                 |                                                                                                                  |                                                                                                                                                                                                                                                                                   |
...
.. _associatesubnetfirewall__request_requestfirewallassociation:

.. table:: **Table 3** RequestFirewallAssociation
...
.. table:: **Table 4** Response body parameters
   ...
   +=======================+=================================================================================+============================================================+
   | firewall              | :ref:`FirewallDetail <associatesubnetfirewall__response_firewalldetail>` object | **Definition**:                                            |
   |                       |                                                                                 |                                                            |
...
.. _associatesubnetfirewall__response_firewalldetail:
...
.. table:: **Table 5** FirewallDetail
   ...
   +-----------------------+-----------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------+
   | tags                  | Array of :ref:`ResponseTag <associatesubnetfirewall__response_responsetag>` objects                 | **Definition**:                                                                                                                                          |
   |                       |                                                                                                     |                                                                                                                                                          |
   ...
   |                       |                                                                                                     | N/A                                                                                                                                                      |
   +-----------------------+-----------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------+
   | associations          | Array of :ref:`FirewallAssociation <associatesubnetfirewall__response_firewallassociation>` objects | **Definition**:                                                                                                                                          |
   |                       |                                                                                                     |                                                                                                                                                          |
   ...
   |                       |                                                                                                     | N/A                                                                                                                                                      |
   +-----------------------+-----------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ingress_rules         | Array of :ref:`FirewallRuleDetail <associatesubnetfirewall__response_firewallruledetail>` objects   | **Definition**:                                                                                                                                          |
   |                       |                                                                                                     |                                                                                                                                                          |
   ...
   |                       |                                                                                                     | N/A                                                                                                                                                      |
   +-----------------------+-----------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------+
   | egress_rules          | Array of :ref:`FirewallRuleDetail <associatesubnetfirewall__response_firewallruledetail>` objects   | **Definition**:                                                                                                                                          |
   |                       |                                                                                                     |                                                                                                                                                          |
...
.. _associatesubnetfirewall__response_responsetag:
...
.. _associatesubnetfirewall__response_firewallassociation:
...
.. _associatesubnetfirewall__response_firewallruledetail:
