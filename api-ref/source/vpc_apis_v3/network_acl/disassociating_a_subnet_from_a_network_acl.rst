:original_name: DisassociateSubnetFirewall.html

.. _DisassociateSubnetFirewall:
...
.. table:: **Table 1** Path Parameters
   ...
   |                 |                 |                 |                                                                                                                                                                                                   |
   |                 |                 |                 | Network ACL ID. You can call the API :ref:`Querying Network ACLs <listfirewall>` to obtain the ID of the target network ACL, and then use this API to disassociate the network ACL from a subnet. |
   |                 |                 |                 |                                                                                                                                                                                                   |
   |                 |                 |                 | **Range**:                                                                                                                                                                                        |
   |                 |                 |                 |                                                                                                                                                                                                   |
   |                 |                 |                 | N/A                                                                                                                                                                                               |
...
.. table:: **Table 2** Request body parameters
   ...
   | Parameter       | Mandatory       | Type                                                                                                  | Description                                                                                                                                                                                                                                                                          |
   +=================+=================+=======================================================================================================+======================================================================================================================================================================================================================================================================================+
   | subnets         | Yes             | Array of :ref:`FirewallAssociation <disassociatesubnetfirewall__request_firewallassociation>` objects | **Definition**:                                                                                                                                                                                                                                                                      |
   |                 |                 |                                                                                                       |                                                                                                                                                                                                                                                                                      |
...
.. _disassociatesubnetfirewall__request_firewallassociation:

.. table:: **Table 3** FirewallAssociation

   +-----------------+-----------------+-----------------+------------------------------------------------------------------------------------------+
   | Parameter       | Mandatory       | Type            | Description                                                                              |
   +=================+=================+=================+==========================================================================================+
   | virsubnet_id    | Yes             | String          | **Definition**:                                                                          |
   |                 |                 |                 |                                                                                          |
...
.. table:: **Table 4** Response body parameters
   ...
   +=======================+====================================================================================+===============================================================+
   | firewall              | :ref:`FirewallDetail <disassociatesubnetfirewall__response_firewalldetail>` object | **Definition**:                                               |
   |                       |                                                                                    |                                                               |
...
.. _disassociatesubnetfirewall__response_firewalldetail:
...
.. table:: **Table 5** FirewallDetail
   ...
   +-----------------------+--------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------+
   | tags                  | Array of :ref:`ResponseTag <disassociatesubnetfirewall__response_responsetag>` objects                 | **Definition**:                                                                                                                                          |
   |                       |                                                                                                        |                                                                                                                                                          |
   ...
   |                       |                                                                                                        | N/A                                                                                                                                                      |
   +-----------------------+--------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------+
   | associations          | Array of :ref:`FirewallAssociation <disassociatesubnetfirewall__response_firewallassociation>` objects | **Definition**:                                                                                                                                          |
   |                       |                                                                                                        |                                                                                                                                                          |
   ...
   |                       |                                                                                                        | N/A                                                                                                                                                      |
   +-----------------------+--------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ingress_rules         | Array of :ref:`FirewallRuleDetail <disassociatesubnetfirewall__response_firewallruledetail>` objects   | **Definition**:                                                                                                                                          |
   |                       |                                                                                                        |                                                                                                                                                          |
   ...
   |                       |                                                                                                        | N/A                                                                                                                                                      |
   +-----------------------+--------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------+
   | egress_rules          | Array of :ref:`FirewallRuleDetail <disassociatesubnetfirewall__response_firewallruledetail>` objects   | **Definition**:                                                                                                                                          |
   |                       |                                                                                                        |                                                                                                                                                          |
...
.. _disassociatesubnetfirewall__response_responsetag:
...
.. _disassociatesubnetfirewall__response_firewallassociation:
...
.. _disassociatesubnetfirewall__response_firewallruledetail:
