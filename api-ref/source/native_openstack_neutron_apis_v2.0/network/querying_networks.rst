:original_name: vpc_network_0001xx.html
...
.. table:: **Table 1** Parameter description
   ...
   +-----------------------+-----------------+-----------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | router:external       | No              | Boolean         | Specifies that whether it is an external network is used as a filtering condition. If router:external=true is used for filtering, other filters are ignored and the external network is directly returned.                         |
   |                       |                 |                 |                                                                                                                                                                                                                                    |
   |                       |                 |                 | The value can be **true** or **false**.                                                                                                                                                                                            |
   +-----------------------+-----------------+-----------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
